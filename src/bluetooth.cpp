...
// 🔑 HARD-CODED RECEIVER MACS (slots 1–5)
uint8_t receiverMACs[][6] = {
    {0x3C, 0xDC, 0x75, 0x63, 0x3E, 0x88}, // Player 1
    {0x24, 0x6F, 0x28, 0xAA, 0xBB, 0xC2}, // Player 2
    {0x24, 0x6F, 0x28, 0xAA, 0xBB, 0xC3}, // Player 3
    {0x24, 0x6F, 0x28, 0xAA, 0xBB, 0xC4}, // Player 4
    {0x24, 0x6F, 0x28, 0xAA, 0xBB, 0xC5}, // Player 5
};
